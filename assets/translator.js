...
function translateToEnglish(){
    ...
    $("#about2").html("We are Americans<br>We are North Carolinians<br>We are web developers");
    ...
    //$("#about2").text("We are Americans");
    //$("#about3").text("We are North Carolinians");
    //$("#about4").text("We are web developers");
    //$("#about5").text("There's no need to beat around the bush. Covid-19 has been one of the most challenging trials our nation has faced in our time. It infects indiscriminately, without mercy, and continues to expand it's reach and firm it's grip on our health as we try to balance social norms with social distancing.");
    //$("#about6").text("Sadly, its impact is felt even harder on our latino community. Over 33% of confirmed cases in the U.S. were of Hispanic or Latino descent, yet information and resources to help this community is scarce. It's our mission to pull in information from trusted, reliable sources to show you the current totals, updated daily, along with helpful tips, links and resources to connect you to the people who can help.");
    //$("#about7").text("Together, we can achieve anything!");
}
...
function translateToSpanish(){
    ...
    //$("#about2").text("Nosotros somos Americanos");
    //$("#about3").text("Nosotros somos Carolinianos del Norte");
    //$("#about4").text("Somos desarrolladores web");

    //$("#about5").text("Pero lo mas importante, estamos preocupados. No hay necesidad de andar por las ramas. Covid-19 ha sido una de las pruebas mas desafiantes que nuestra nacion ha enfrentado en nuestro tiemo. Infecta indiscriminadamente sin piedad, y coninua expandiendo su alcance y firme su control sobre nuestra salud minetras tratamos de equilibrar las normas sociales con el distanciamiento social.");
    //$("#about6").text("Lamentablemente, su impacto se siente aun mas duro en nuestra comunidad latina. Mas del 33% de los casos confirmados en Carolina del Norte eran de ascendencia hispana o latina, sin embargo, los recursos de información para ayudar a esta comunidad son escasos. Nuestra mision es obtener información de fuentes confiables para mostrarle los totales actualizados, junto con enlaces y recursos utiles para conectarse con personas que pueden ayudar.");
    //$("#about7").text("¡Juntos podemos lograr cualquier cosa!");
}
